...
- *Over 8 hours* of self-paced, on-demand video instruction on Scheme fundamentals and practical programming with Guile, broken into easily consumable chunks
...
- *3 live 1-hour group Q&A sessions* (optional) to chat with me, ask questions, and discuss the course content
...
Every two weeks starting on *Saturday, March 16, 2024* you will receive a new batch of course modules with high-quality instructional material both in text and video form.  To kick off the first week, we will have an introductory live session the next day (Sunday, March 17) to set the tone for the rest of the course!

At the end of this content, you will be given a series of exercises to work through over the next 2 weeks.  You will be able to ask questions and discuss the material and exercises with me and the other participants in the private forum group throughout those 2 weeks.
...
At the mid-point of the course, we will have a 1-hour live group Q&A session where we will meet together and discuss what we've learned so far.  You will be able to chat with me and the other participants live via voice and/or text chat during this session!  We will have the final live session at the end of the last week of the course.

** Live Q&A Session Schedule

The 1-hour live Q&A meetings will generally occur on *Sundays at 16:00 UTC*.  For this iteration of the course, the live sessions will occur on these dates, click the link for your local time:

- [[https://time.is/1600_17_Mar_2024_in_UTC][March 17, 2024]]
- [[https://time.is/1600_14_Apr_2024_in_UTC][April 14, 2024]]
- [[https://time.is/1600_12_May_2024_in_UTC][May 12, 2024]]
...
If you're ready to learn Scheme, head over to the [[https://systemcrafters.store/products/hands-on-guile-scheme-for-beginners-march-2024][System Crafters Store]] to register or click the blue button below:

#+BEGIN_EXPORT html

<p>

<a href="https://systemcrafters.store/products/hands-on-guile-scheme-for-beginners-march-2024">
...
<b><a href="https://systemcrafters.store/products/hands-on-guile-scheme-for-beginners-march-2024" class="register-button center">Click Here to Register for Hands-On Guile Scheme for Beginners!</a></b>
...
If you *register before 06:00 UTC, Monday March 4th* you will receive an *automatic discount of 15%* from the course price!

** Refund Policy

I am committed to giving you the best possible learning experience with this course!  If you are unsure about whether the course is right for you, I am offering a *full refund upon request before the end of the first 2 weeks of the course* so that you can give it a fair trial and decide whether you want to continue.
...
If this isn't a good time for you to join this course, I will run another iteration of it in April or May this year!
