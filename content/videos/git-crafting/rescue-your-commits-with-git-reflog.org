#+title: How to Rescue Your Commits with Git Reflog
#+video: K7-wrGpnqUM
...
If you enjoy this video and want to dive deeper into Git and other interesting topics, check out the links in the description for more resources, like my upcoming [[https://systemcrafters.net/courses/git-good-workshop/][Git Good workshop]], where we'll cover real-world Git techniques step by step.
